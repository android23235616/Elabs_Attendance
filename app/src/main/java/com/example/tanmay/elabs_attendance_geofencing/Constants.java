...
public class Constants {
    ...
    public static final String Registration_Shared_Preferences="SharedPrefernces3";
    ...
    public static final double Lat1 = 20.35138524475558;
    public static final double Lng1= 85.82143073306530;
    public static final double Lat = 20.351343;
    public static final double Lng= 85.821465;
